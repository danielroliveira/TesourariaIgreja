...
{
	partial class frmUsuarioProcura
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.clnUsuario = new ComponentOwl.BetterListView.BetterListViewColumnHeader();
			...
			// lblTitulo
			// 
			this.lblTitulo.Location = new System.Drawing.Point(178, 0);
			this.lblTitulo.Size = new System.Drawing.Size(284, 50);
			this.lblTitulo.TabIndex = 0;
			this.lblTitulo.Text = "Escolher Usuário";
			// 
			// btnClose
			// 
			...
			this.btnFechar.Location = new System.Drawing.Point(337, 445);
			...
			this.btnEscolher.Location = new System.Drawing.Point(22, 445);
			...
			this.lstItens.Columns.Add(this.clnUsuario);
			...
			this.lstItens.Size = new System.Drawing.Size(457, 324);
			...
			// clnUsuario
			// 
			this.clnUsuario.AllowResize = false;
			this.clnUsuario.Name = "clnUsuario";
			this.clnUsuario.Text = "Usuários";
			this.clnUsuario.Width = 350;
			// 
			// grpGrupo
			// 
			...
			this.Name = "frmUsuarioProcura";
			this.Activated += new System.EventHandler(this.frmUsuarioProcura_Activated);
			this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.frmUsuarioProcura_FormClosed);
		...
		internal ComponentOwl.BetterListView.BetterListViewColumnHeader clnUsuario;
