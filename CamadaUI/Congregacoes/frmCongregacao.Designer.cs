namespace CamadaUI.Congregacoes
{
	partial class frmCongregacao
	{
		...
		private void InitializeComponent()
		{
			...
			this.Label6.Location = new System.Drawing.Point(61, 194);
			this.Label6.Name = "Label6";
			this.Label6.Size = new System.Drawing.Size(66, 19);
			this.Label6.TabIndex = 7;
			this.Label6.Text = "Regional";
			// 
			// txtEmail
			// 
			...
			this.dgvReuniao.RowsDefaultCellStyle = dataGridViewCellStyle4;
			...
			this.dgvSetor.AlternatingRowsDefaultCellStyle = dataGridViewCellStyle5;
			...
			this.dgvSetor.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle6;
			...
			this.dgvSetor.DefaultCellStyle = dataGridViewCellStyle7;
