...
{
	partial class frmEntradaOrigemControle
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lblTitulo.Text = "Controle de Origens de Entrada";
			// 
			// btnClose
			// 
			...
			this.clnCadastro.HeaderText = "Descrição da Origem";
			...
			this.Shown += new System.EventHandler(this.frmEntradaOrigemControle_Shown);
