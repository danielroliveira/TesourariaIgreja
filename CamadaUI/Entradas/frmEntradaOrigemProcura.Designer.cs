...
{
	partial class frmEntradaOrigemProcura
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.Name = "frmEntradaOrigemProcura";
			this.Activated += new System.EventHandler(this.frmEntradaOrigemProcura_Activated);
			this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.frmEntradaOrigemProcura_FormClosed);
