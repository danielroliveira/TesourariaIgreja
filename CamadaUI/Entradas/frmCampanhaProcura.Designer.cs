namespace CamadaUI.Entradas
{
	partial class frmCampanhaProcura
	{
		...
		private void InitializeComponent()
		{
			...
			this.lblTitulo.Text = "Escolher Campanha";
			// 
			// btnClose
			// 
			...
			this.btnFechar.Location = new System.Drawing.Point(276, 382);
			...
			this.lstItens.Size = new System.Drawing.Size(396, 265);
			...
			this.clnItem.Text = "Campanhas de Arrecadação";
			...
			this.Name = "frmCampanhaProcura";
			this.Activated += new System.EventHandler(this.frmCampanhaProcura_Activated);
			this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.frmCampanhaProcura_FormClosed);
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmCampanhaProcura_KeyDown);
