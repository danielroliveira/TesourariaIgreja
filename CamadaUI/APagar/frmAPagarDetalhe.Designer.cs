namespace CamadaUI.APagar
{
	partial class frmAPagarDetalhe
	{
		...
		private void InitializeComponent()
		{
			...
			this.lblIdentificador.Text = "Descrição da Despesa";
			...
			this.lblParcela.Text = "Descrição da Despesa";
			...
			this.lblCobrancaForma.Text = "Descrição da Despesa";
			...
			this.lblBanco.Text = "Descrição da Despesa";
			...
			this.lblVencimento.Text = "Descrição da Despesa";
			...
			this.lblAPagarValor.Text = "Descrição da Despesa";
			...
			this.lblReferencia.Text = "Descrição da Despesa";
