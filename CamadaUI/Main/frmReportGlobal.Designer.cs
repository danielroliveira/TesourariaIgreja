namespace CamadaUI.Main
{
	partial class frmReportGlobal
	{
		...
		private void InitializeComponent()
		{
			...
			this.lblTitulo.Size = new System.Drawing.Size(486, 50);
			this.lblTitulo.Text = "Relatório Geral";
			// 
			// rptvPadrao
			// 
			...
			this.Name = "frmReportGlobal";
			this.Load += new System.EventHandler(this.frmReportGlobal_Load);
