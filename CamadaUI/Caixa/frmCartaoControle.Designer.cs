...
{
	partial class frmCartaoControle
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lblTitulo.Text = "Contole de Cartão e Taxas";
			// 
			// btnClose
			// 
			...
			// clnCadastro
			// 
			this.clnCadastro.HeaderText = "Operadora";
			this.clnCadastro.Name = "clnCadastro";
			this.clnCadastro.ReadOnly = true;
			this.clnCadastro.Width = 200;
			// 
			// clnBandeira
			// 
			this.clnBandeira.HeaderText = "Bandeira";
			this.clnBandeira.Name = "clnBandeira";
			this.clnBandeira.ReadOnly = true;
			this.clnBandeira.Width = 150;
			// 
			// clnImage
			// 
			...
			this.Name = "frmCartaoControle";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmCartaoControle_KeyDown);
		...
		private System.Windows.Forms.DataGridViewTextBoxColumn clnBandeira;
