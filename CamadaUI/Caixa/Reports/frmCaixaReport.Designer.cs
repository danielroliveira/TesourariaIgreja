namespace CamadaUI.Caixa.Reports
{
	partial class frmCaixaReport
	{
		...
		private void InitializeComponent()
		{
			...
			this.lblTitulo.Text = "Imprimir Caixa Relatório";
			// 
			// rptvPadrao
			// 
			...
			this.rptvPadrao.LocalReport.ReportEmbeddedResource = "CamadaUI.Caixa.Reports.rptCaixa.rdlc";
			...
			this.Name = "frmCaixaReport";
			this.Load += new System.EventHandler(this.frmCaixaReport_Load);
