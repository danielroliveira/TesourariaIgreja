...
{
	partial class frmBancosControle
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			// lblTitulo
			// 
			this.lblTitulo.Location = new System.Drawing.Point(353, 0);
			this.lblTitulo.Size = new System.Drawing.Size(228, 50);
			this.lblTitulo.TabIndex = 0;
			this.lblTitulo.Text = "Controle de Bancos";
			// 
			// btnClose
			// 
			...
			this.Name = "frmBancosControle";
			this.Padding = new System.Windows.Forms.Padding(2);
			this.Shown += new System.EventHandler(this.frmBancosControle_Shown);
