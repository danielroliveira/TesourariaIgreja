...
{
	public partial class frmFuncionarioListagem : CamadaUI.Modals.frmModFinBorder
	{
		...
		public frmFuncionarioListagem(bool IsProcura, Form formOrigem = null)
		{
			InitializeComponent();
		...
		private void ObterDados()
		{
			try
			{
				...
				_sourceList = cBLL.GetListCredor(string.Empty, rbtAtivo.Checked, 5);
		...
		private void FormataListagem()
		{
			...
			//--- Add Columns
			dgvListagem.Columns.AddRange(clnID, clnCadastro, clnFuncao, clnImage);
		}
		...
		private void btnAdicionar_Click(object sender, EventArgs e)
		{
			...
			{
				frmCredor frm = new frmCredor(new objCredor(null), null, 5);
		...
		private void btnEditar_Click(object sender, EventArgs e)
		{
			...
			if (!_isProcura) // EDITAR
			{
				...
				//--- open edit form
				frmCredor frm = new frmCredor(item, null, 5);
				frm.MdiParent = Application.OpenForms.OfType<frmPrincipal>().FirstOrDefault();
				DesativaMenuPrincipal();
				Close();
				frm.Show();
		...
		------------------------------------------------------------------------------------------------*/
		private void frmFuncionarioListagem_KeyDown(object sender, KeyEventArgs e)
		{
			switch (e.KeyCode)
			{
				case Keys.Escape:
		...
		//------------------------------------------------------------------------------------------------------------
		private void frmFuncionarioListagem_Activated(object sender, EventArgs e)
		{
		...
		private void frmFuncionarioListagem_FormClosed(object sender, FormClosedEventArgs e)
		{
			if (_formOrigem != null && _formOrigem.GetType() != typeof(frmPrincipal))
			{
				Panel pnl = (Panel)_formOrigem.Controls["Panel1"];
