namespace CamadaUI.Registres
{
	partial class frmCongregacao
	{
		...
		private void InitializeComponent()
		{
			...
			this.txtEnderecoNumero.MaxLength = 2;
			...
			this.txtEnderecoComplemento.MaxLength = 2;
			...
			this.btnProcLogoColor.Location = new System.Drawing.Point(368, 191);
			...
			this.btnProcLogoColor.TabIndex = 9;
			...
			this.Controls.Add(this.btnProcLogoColor);
			...
			this.Controls.SetChildIndex(this.btnProcLogoColor, 0);
