...
{
	partial class frmProvisorioAutorizante
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.clnAutorizante = new ComponentOwl.BetterListView.BetterListViewColumnHeader();
			...
			this.lblTitulo.Text = "Escolher Autorizante";
			// 
			// btnClose
			// 
			...
			this.lstItens.Columns.Add(this.clnAutorizante);
			...
			// clnAutorizante
			// 
			this.clnAutorizante.AllowResize = false;
			this.clnAutorizante.Name = "clnAutorizante";
			this.clnAutorizante.Text = "Autorizante da Despesa";
			this.clnAutorizante.Width = 400;
			// 
			// label1
			// 
			...
			this.Name = "frmProvisorioAutorizante";
			this.Activated += new System.EventHandler(this.frmProvisorioAutorizante_Activated);
			this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.frmProvisorioAutorizante_FormClosed);
		...
		internal ComponentOwl.BetterListView.BetterListViewColumnHeader clnAutorizante;
