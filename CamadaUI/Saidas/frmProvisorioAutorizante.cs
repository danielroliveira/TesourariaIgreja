...
{
	public partial class frmProvisorioAutorizante : CamadaUI.Modals.frmModFinBorder
	{
		...
		public frmProvisorioAutorizante(Form formOrigem, string DefaultID = null)
		{
			InitializeComponent();
		...
		private void FormataListagem()
		{
			...
			clnAutorizante.DisplayMember = "Autorizante";
			clnAutorizante.ValueMember = "Autorizante";
		...
		private void frmProvisorioAutorizante_Activated(object sender, EventArgs e)
		{
			if (_formOrigem != null)
			{
		...
		private void frmProvisorioAutorizante_FormClosed(object sender, FormClosedEventArgs e)
		{
			if (_formOrigem != null)
			{
				Panel pnl = (Panel)_formOrigem.Controls["Panel1"];
