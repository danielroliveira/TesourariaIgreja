...
{
	public partial class frmDespesaPeriodicaListagemFiltro : CamadaUI.Modals.frmModFinBorder
	{
		...
		public frmDespesaPeriodicaListagemFiltro(frmDespesaListagem formOrigem)
		{
			InitializeComponent();
